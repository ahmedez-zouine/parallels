...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/02 21:42:33 by aez-zoui          #+#    #+#             */
/*   Updated: 2024/11/02 21:42:34 by aez-zoui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo.h"

void	init_philos(t_engine *en, t_philo *philos, pthread_mutex_t *forks,
		char **argv)
{
	int	i;
...
void	init_forks(t_engine *engine, pthread_mutex_t *forks, int count)
{
	int	i;
...
void	init_engine(t_engine *engine, t_philo *philos, pthread_mutex_t *forks)
{
	engine->forks = forks;
